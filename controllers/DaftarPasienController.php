...
/**
 * DaftarPasienController implements the CRUD actions for Pasien model.
 */
class DaftarPasienController extends Controller
{
    ...
    public function actionView($id_pasien)
    {
        ...
        $id_tindakan = $pasien->id_tindakan;
        // $id_obat = 3;
        // $id_tindakan = $id_pasien;
        $obat = Obat::findOne($id_obat);
        $tindakan = Tindakan::findOne($id_tindakan);
